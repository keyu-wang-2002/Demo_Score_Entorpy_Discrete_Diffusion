...
To address these limitations, SEDD introduces the **Score Entropy Loss** as a replacement for the MSE objective:  
$s_\theta(x)_y - \frac{p_{\text{data}}(y)}{p_{\text{data}}(x)} \log s_\theta(x)_y$.
