...
To address these limitations, SEDD introduces the **Score Entropy Loss** as a replacement for the MSE objective:  <img src="https://latex.codecogs.com/png.image?\dpi{120} s_\theta(x)_y-\frac{p_{data}(y)}{p_{data}(x)}\log s_\theta(x)_y" />
